...
foreach ($arResult['ITEMS'] as $key => $arItem) {
    ...
    ?>
    <div id="<? echo $strMainID; ?>" class="bx_slider_block<? echo($boolFirst ? ' active' : ''); ?>"
        ...
        <div class="bx_slider_content_container">
            <h2 class="bx_slider_title"><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"><? echo $arItem['NAME']; ?></a>
            </h2>
            <?
                    ...
                    if (!empty($arItem['MIN_PRICE'])) {
                        ...
                        <?
                            ...
                            <div id="<? echo $arItemIDs['PRICE']; ?>"
                                 class="bx_slider_current_price<? echo($boolOldPrice ? '' : ' bx_no_oldprice'); ?>">
                                <?
                                echo $arItem['MIN_PRICE']['PRINT_DISCOUNT_VALUE'];
                                if ($boolOldPrice) {
                                    ?>
                                    <div id="<? echo $arItemIDs['OLD_PRICE']; ?>"
                                         class="bx_slider_old_price"><? echo $arItem['MIN_PRICE']['PRINT_VALUE']; ?></div>
                                <?
                                }
                                ?>
                            </div>
...
<?
    ...
    <script type="text/javascript">
        var <? echo $strObName; ?> =
        new JCCatalogTopBanner(<? echo CUtil::PhpToJSObject($arJSParams, false, true); ?>);
    </script><?
}
}
?>
