                ...
                <table class="sale_order_full_table">
                    ...
                    <tr>
                        <td nowrap><? echo GetMessage("STOF_LOGIN") ?> <span class="starrequired">*</span><br/>
                            <input type="text" name="USER_LOGIN" maxlength="30" size="30"
                                   value="<?= $arResult["AUTH"]["USER_LOGIN"] ?>"></td>
                    </tr>
                    <tr>
                    ...
                    <table class="sale_order_full_table">
                        ...
                        <tr>
                            <td nowrap>
                                ...
                                <input type="text" name="NEW_LAST_NAME" size="40"
                        ...
                        <? if ($arResult["AUTH"]["new_user_registration_email_confirmation"] != "Y"): ?>
                            <tr>
                                <td nowrap><input type="radio" id="NEW_GENERATE_N" name="NEW_GENERATE" value="N"
                                                  OnClick="ChangeGenerate(false)"<? if ($_POST["NEW_GENERATE"] == "N") echo " checked"; ?>>
                                    <label for="NEW_GENERATE_N"><? echo GetMessage("STOF_MY_PASSWORD") ?></label></td>
                            </tr>
                        <? endif; ?>
                        <? if ($arResult["AUTH"]["new_user_registration_email_confirmation"] != "Y"): ?>
                        <tr>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <? if ($arResult["AUTH"]["new_user_registration_email_confirmation"] != "Y"): ?>
                                                <td width="0%">&nbsp;&nbsp;&nbsp;</td>
                                            <? endif; ?>
                                            <td><? echo GetMessage("STOF_LOGIN") ?> <span
                                                    class="starrequired">*</span><br/>
                                                <input type="text" name="NEW_LOGIN" size="30"
                                        ...
                                        <tr>
                                            ...
                                            <? endif; ?>
                                            <td>
                                                <? echo GetMessage("STOF_PASSWORD") ?> <span
                                                    class="starrequired">*</span><br/>
                                        ...
                                        <tr>
                                            ...
                                            <? endif; ?>
                                            <td>
                                                <? echo GetMessage("STOF_RE_PASSWORD") ?> <span
                                                    class="starrequired">*</span><br/>
