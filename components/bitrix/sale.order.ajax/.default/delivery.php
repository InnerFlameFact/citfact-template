...
<script type="text/javascript">
    ...
    function GetBuyerStore() {
        ...
        <?=GetMessage("SOA_ORDER_GIVE_TITLE")?>: '+BX('POPUP_STORE_NAME').value;
                                ...
                                <div class="bx_description">
									...
									<span class="bx_result_price"><!-- click on this should not cause form submit -->
                                        ...
                                        if ($arProfile["CHECKED"] == "Y" && doubleval($arResult["DELIVERY_PRICE"]) > 0):
                                            ?>
                                            <div><?= GetMessage("SALE_DELIV_PRICE") ?>
                                                :&nbsp;<b><?= $arResult["DELIVERY_PRICE_FORMATED"] ?></b></div>
                                            <?
                ...
                <div class="bx_block w100 vertical">
                    ...
                    <div class="bx_element">
                        ...
                        <label for="ID_DELIVERY_ID_<?= $arDelivery["ID"] ?>" <?= $clickHandler ?>>
                            ...
                            <div class="bx_logotype"><span style='background-image:url(<?= $deliveryImgURL ?>);'></span>
                            </div>
                                    ...
                                    if (count($arDelivery["STORE"]) > 0):
                                        ...
                                        <span
                                            id="select_store"<? if (strlen($arResult["STORE_LIST"][$arResult["BUYER_STORE"]]["TITLE"]) <= 0) echo " style=\"display:none;\""; ?>>
												<span class="select_store"><?= GetMessage('SOA_ORDER_GIVE_TITLE'); ?>
                                                    : </span>
